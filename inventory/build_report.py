...
work/arkit_47331963 + 41069021 (+_fused x2, 5.1G)   ARKitScenes converted: RGB+depth+conf+DAV2 priors+transforms
data/arkit (2.4G)                                   raw remainder (highres_depth etc.) - candidate for cleanup after scene-1 eval
...
<main>
<div class="kicker">FaceScan research campaign · living inventory · v4 (2026-07-09)</div>
...
100&#8202;mm laser-support crop on accuracy (GT lacks ceiling), per-arm 20&#8202;mm ICP. Scene 47331963 trained (all 5 arms), awaiting proxy eval. Full protocol audit trail in paperB/score_41069021_v1&#8211;v6.py.</p>
