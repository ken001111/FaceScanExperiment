...
MATRIX = [
    ...
    ("GeoSVR", "fail:billboard / mush", "ok:dummy clean · ken sky-shell", "warn:ken bg solved, motion remains"),
...
matrix_html = "".join(
    f"<tr><td>{m}</td>{chip(a)}{chip(b)}{chip(c)}</tr>" for m, a, b, c in MATRIX)
...
<main>
<div class="kicker">FaceScan research campaign · July 3–7, 2026</div>
...
every mesh, table, and preview produced this week, with paths to find them.</p>
...
<p class="sub">The week's central finding: preparation, not method, decided the outcome.</p>
<div class="tablewrap"><table>
<tr><th>Method</th><th>circle-composited</th><th>raw images</th><th>true mattes</th></tr>
{matrix_html}
</table></div>
...
<h2>8 · Validated infrastructure</h2>
