...
DR="$HOME/FaceScan/work/face_scan"          # correct ken2 data root
[ -f "$DR/transforms_train.json" ] || { echo "WRONG DR"; exit 1; }
rm -f "$DR/points3d.ply"                     # force random init
cd "$GS"
